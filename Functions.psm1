##########
#
# Windows Optimizer - Original functions
#
...
# Stop and disable Superfetch service (Chris Titus states that it is not applicable to server, although Disassembler0 does not say so)
...
# Start and enable Superfetch service (Chris Titus states that it is not applicable to server, although Disassembler0 does not say so)
